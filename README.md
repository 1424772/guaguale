...
- 新用户初始 1000 虚拟金币
- 八款卡片价格和动态余额门槛展示
- 购买全部八款卡并在服务端提前锁定结果；第 7 款五项鉴定取最低等级，第 8 款固定概率且仅可手动刮开
- 自适应 Canvas 刮层、多种判奖版式和中奖兑奖
- 每日登录领取 100 金币
- 每日手动洗 5 个脏盘子，每个奖励 5 金币
- 每日免费卡转盘：仅抽余额可购买范围内的第 1–6 款卡，第 7、8 款排除
- 可持久化互动桌面：购卡托盘、自由拖放、兑奖投放，以及购买后开放的 10 格固定卡槽与垃圾桶 5 秒撤销
- 永久道具商店：好运 0–10 级、刮奖范围 1–10 级、垃圾桶、固定卡槽、风扇 1–8 级、真实概率/RTP 明细、二次确认与幂等扣款
- 自动刮奖机器人：本体、速度 1–8 级、队列 1–6 级、拦截 1–8 级；中奖自动兑奖，未中奖退回桌面，离线暂停
- 风扇清理：持续按住启动，已刮卡直接清理，未刮卡由机器人拦截与风扇吹错率共同判定，固定卡槽不受影响
